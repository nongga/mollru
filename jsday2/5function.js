...
result = myfunc1(5);        //인자값이 없음 -> 리턴값 계산 못함 -> 리턴 NaN(not a number)
console.log('result : ' + result);
...
myfunc5(999);           //리턴값을 저장 안하고있음 -> 무용지물
console.log(myfunc5(999));      //myfunc5 실행 그 후 리턴값이 없으므로 undefined 출력, undefined 출력

//자바에서는 리턴값이 없는 메소드를 리턴값을 받아서 저장/ 출력하려고하면 오류
//자바스크립트에서는 오류없이 undefined입니다.